...
-- ============================================================================
-- SOURCE: supabase/migrations/0016_inquiry_notify_trigger.sql
-- OPTIONAL / CONDITIONAL — do not run blindly, see its own header comment.
-- Only needed if Dashboard -> Integrations -> Database Webhooks itself
-- fails with `ERROR: 3F000: schema "supabase_functions" does not exist`
-- when creating the notify-inquiry webhook (docs/EMAIL_NOTIFICATIONS_SETUP.md
-- step 4). Requires substituting <PROJECT_URL> and <ANON_KEY> with this
-- project's real values (Settings -> API) before running.
-- ============================================================================
...
-- ============================================================================
-- SOURCE: supabase/migrations/0017_inquiry_notify_trigger_shared_secret.sql
-- OPTIONAL / CONDITIONAL — only relevant if 0016 above was used AND its
-- anon-key Authorization header was rejected. Requires substituting
-- <PROJECT_URL> and <WEBHOOK_SECRET> (a random string of your own choosing,
-- matched to the notify-inquiry function's WEBHOOK_SECRET secret) first.
-- Supersedes 0016's function body only — the trigger itself is unchanged.
-- ============================================================================
...
-- ============================================================================
-- SOURCE: supabase/migrations/0018_advisory_sales_cms_wiring.sql
-- ============================================================================
...
-- ============================================================================
-- SOURCE: supabase/migrations/0019_insights_item_links.sql
-- ============================================================================
